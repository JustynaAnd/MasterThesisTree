...
labels = numeric_features + ordinal_features + list(labels_cat)
print(len(labels))
...
print(importance)
ax = importance.plot.barh(x = 'feature', color='lightgreen')
plt.savefig('importance.png', facecolor='w', edgecolor='w', orientation='portrait', transparent=False, pad_inches=0.1, bbox_inches = 'tight')
plt.show
